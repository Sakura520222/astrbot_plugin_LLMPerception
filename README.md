...
LLMPerception 是一个为 AstrBot 设计的智能环境感知插件，旨在增强 LLM 对用户所处环境的理解能力。通过精确的时间感知、节假日识别、平台环境分析和情感状态感知，让 AI 能够提供更贴心、更符合场景的智能回复。

✨ **核心价值**：让AI不再是冰冷的文字生成器，而是真正理解你当前处境和情感状态的有温度的助手。
...
### 😊 情感状态感知
- 🎭 **多情感识别**：支持开心、生气、悲伤、惊讶、恐惧、中性等6种情感
- 🔤 **关键词匹配**：基于关键词的智能情感分析
- 😀 **表情符号检测**：支持常见表情符号的情感识别
- 🛡️ **智能边界检查**：防止单字关键词误匹配（如"你好"中的"好"）
- 🔍 **中性情感过滤**：未检测到情感时不显示情感信息
...
#### ✨ 新增功能
- 😊 **情感状态感知**：新增情感分析功能，支持开心、生气、悲伤、惊讶、恐惧、中性等6种情感识别
- 🔤 **智能关键词匹配**：基于关键词的情感分析算法
- 😀 **表情符号检测**：支持常见表情符号的情感识别
- 🛡️ **智能边界检查**：防止单字关键词误匹配（如"你好"中的"好"）
- 🔍 **中性情感过滤**：未检测到情感时不显示情感信息

#### ⚙️ 配置增强
- 📝 **新增情感感知配置项**：`enable_emotion_perception` 控制情感感知功能开关
- 🔧 **算法优化**：优化情感分析算法，提高识别准确率

#### 📚 文档优化
- 📋 **功能文档更新**：添加情感感知功能说明和使用示例
- ✅ **测试用例完善**：新增13个情感分析测试用例
...
| `enable_emotion_perception` | bool | `true` | 😊 启用/禁用情感状态感知功能 |
...
### 😊 情感状态场景
AI能够识别用户的情感状态并相应调整回复：
```
[发送时间: 2025-10-29 15:30:00 | 周三, 工作日, 下午 | 平台: QQ, 私聊 | 情感: 开心]
喜欢你！
```

```
[发送时间: 2025-10-29 15:30:00 | 周三, 工作日, 下午 | 平台: QQ, 私聊 | 情感: 生气]
我很生气！
```

```
[发送时间: 2025-10-29 15:30:00 | 周三, 工作日, 下午 | 平台: QQ, 私聊]
你好
```
（中性情感不显示情感信息）
